...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
     ...
     * @Groups({"user_list", "user_show", "organizer_show", "band_show", "organizer_create", "organizer_update"})
     */
    private $id;
     ...
     * @Groups({"user_list", "user_show", "user_create", "user_update","band_list","band_show", "organizer_list", "organizer_show"})
     */
    private $picture;
